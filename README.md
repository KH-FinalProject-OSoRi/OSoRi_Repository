...
| 조수인   |  <img src="https://avatars.githubusercontent.com/u/250043719?v=4" alt="조수인" width="100">    |     <ul><li>캘린더뷰 구현/상세 소비 내역 영역 구현</li><li>개인 가계부 소비 패턴(월말 지출액 예상, 다음달 소비액 예상, 카테고리별 지출액 합산) 분석 기능 구현</li><li>그룹 가계부 종료까지 남은 기간/예산 계산 기능/사용자 별 소비 양상 구현</li><li>회원가입시 기본 뱃지, 개인/그룹 챌린지 달성시 뱃지 지급 기능 구현</li><li>내 뱃지 페이지 구현</li><li>마이페이지 내 최근 받은 뱃지 보여주기 기능 구현</li><li>새로운 챌린지 신청 기능 구현</li></ul>  |
