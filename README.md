...
| 조수인   |  <img src="https://avatars.githubusercontent.com/u/250043719?v=4" alt="조수인" width="100">    |     <ul><li>캘린더뷰 페이지 구현</li><li>개인 가계부 소비 패턴(카테고리별 소비 합산/월말, 다음달 지출액 예상) 분석 기능 구현</li><li>그룹 가계부 기간 내 가용 예산 계산 기능/사용자 소비 차트 구현</li><li>그룹 챌린지 성공/실패 판정 여부 로직</li><li>회원가입 시 기본 뱃지, 그룹 챌린지 달성 시 뱃지 지급 기능 구현</li><li>내 뱃지 페이지 구현</li><li>마이페이지 내 최근 받은 뱃지 보여주기 기능 구현</li><li>마이페이지 내 이상치 탐지를 통한 카테고리별 과다 지출 알림 기능 구현</li><li>새로운 챌린지 신청 기능 구현</li></ul>  |
