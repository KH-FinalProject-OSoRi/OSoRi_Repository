...
| 조수인   |  <img src="https://avatars.githubusercontent.com/u/250043719?v=4" alt="조수인" width="100">    |     <ul><li>캘린더뷰 페이지 구현/상세 소비 내역 영역 구현</li><li>개인 가계부 소비 패턴(카테고리별 소비, 월별 지출 분석 및 예측) 분석 기능 구현</li><li>그룹 가계부 종료까지 남은 기간/예산 계산 기능/사용자 소비 차트 구현</li><li>그룹 챌린지 성공/실패 판정 여부 로직</li><li>회원가입 시 기본 뱃지, 그룹 챌린지 달성 시 뱃지 지급 기능 구현</li><li>내 뱃지 페이지 구현</li><li>마이페이지 내 최근 받은 뱃지 보여주기 기능 구현</li><li>마이페이지 내 가계부 탭 내 이상치 탐지를 통한 카테고리별 과다 지출 알림</li><li>새로운 챌린지 신청 기능 구현</li></ul>  |
| 강민채    |  <img src="https://avatars.githubusercontent.com/u/216668731?v=4" alt="강민채" width="100">    | <ul><li>개인/그룹 가계부 상세페이지 구현</li><li>개인/그룹 가계부 수입/지출 내역 목록 조회 기능 구현</li><li>개인/그룹 가계부 수입/지출 내역 목록 수정/삭제 기능 구현</li><li>개인/그룹 가계부 필터링 검색 기능 구현</li><li>수입/지출 내역 입력 기능 구현</li><li>최근 수입/지출 내역 목록 선택시 자동 입력 기능 구현</li><li>영수증 분석하기 (네이버 클로바/카카오 검색 API) 기능 구현</li><li>그룹 가계부 N분의 1 계산 기능 구현</li><li>그룹 가계부와 개인 가계부 연동 기능 구현</li><li>프로필 사진 변경</li></ul>    |
<br/>
<br/>
